...
IaCSecBench Security Framework & Evaluation Protocol (security_framework/ & evaluation/)
  ...
  ├── evaluation/analyze.py       Aggregation, statistics, leaderboard CSV (CLI entry point)
  ├── evaluation/tables.py        LaTeX table emitters + generated-table structural guard
