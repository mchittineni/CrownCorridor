...
def emit_strictness_table(
    ...
    lines = [
        ...
        "The criteria are not a single ordering: \\emph{resource} is stricter than "
        "\\emph{control} on this corpus, because a tool can name the seeded control "
        "under a rule it attributes to a different resource address. "
